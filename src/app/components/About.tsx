...
const teamMembers = [
  {
    ...
    bio: 'Laurentius leads the commercial direction of Avitus. He stays close to the pace, expectations, and client dynamics of premium firms so every system is shaped around how real engagements begin, progress, and convert.',
    focus:
  ...
  },
  {
    ...
    bio: 'Christopher architects the technical layer behind Avitus. He designs the intake logic, qualification structure, routing, summaries, and operational systems that keep client coordination clear and disciplined.',
    focus:
      ...
      <section className="container mx-auto px-6 pb-32 md:px-12">
        <div className="relative mb-24 aspect-[21/9] w-full overflow-hidden bg-[#E5E3DB]">
          <img
            ...
            alt="Avitus studio minimal interior"
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-12 md:gap-16">
          ...
          <div className="border-t border-[#E5E3DB] pt-6 md:col-span-8">
            <div className="prose prose-lg max-w-none font-light leading-relaxed text-[#1A1A1A]/80">
              <p className="mb-6">
                Avitus was founded on a simple observation: the world&apos;s most premium design, architecture, and
          ...
          <div className="border-t border-[#E5E3DB] pt-6 md:col-span-8">
            <div className="mb-12 max-w-3xl">
              <p className="text-lg font-light leading-relaxed text-[#1A1A1A]/80">
                Avitus is led by two co-founders with distinct responsibilities. One stays close to the commercial
